...
def run_server(host: str = "0.0.0.0", port: int = 5555, reload: bool = True):
    print("\n" + "=" * 50)
    print(f"🚀 启动会议系统服务")
...
示例:
  python run.py dev                    # 开发模式，默认端口 5555
  python run.py dev --port 8000        # 开发模式，端口 8000
  python run.py prod                    # 生产模式，绑定 0.0.0.0:5555
    """)
